...
def main(argv):
    ...
    assert len(argv) == 4, "Script takes 4 arguments <case number><support><input_file_path><output_file_path"

    # Unpack arguments
    case_num, s, input_file, output_file = argv
    ...
    if case_num == "1":
        ...
        rdd = lines.map(lambda x: (x.split(',')[1], x.split(',')[0])) \
